...
class OptionalPasswordValidatorTest {
    ...
    private final OptionalPasswordValidator optionalPasswordValidator = new OptionalPasswordValidator(new PasswordValidator.PasswordValidationDataWrapper(7, 14, PasswordConstraint.LENIENT));
